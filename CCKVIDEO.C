...
#include "svga.h"                       /* vbe routines (from svgakit) */
#include "cckfile.h"                    /* file io handling */
#include "cckvideo.h"                   /* header for this file */
#include "cckfile.h"                    /* for globalpalette */
#include "debug.h"                      /* types like bool, ushort */
#include <graph.h>                      /* _setvideomode() */
/********************************************************************
 * public vars
 ********************************************************************/
...
int             INITIAL_DIB_WIDTH = 320;/* dimensions of cur. screenmode */
...
VBE_modeInfo    mi;
        ...
        if (ignoreVBE) return; /* don't use VBE lfb. */
        if ((VBEVersion) < 0x200) {};
        /* is lfb available ? */
...
*************************************************************************/
ushort coockie_getLinearSelector(VBE_modeInfo *mi)
{
